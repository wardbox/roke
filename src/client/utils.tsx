...
const SectionHeader = ({ icon: Icon, title, id }: { icon: Icon, title: string, id: string }) => (
...
export default function Utils() {
  ...
  const navItems: NavItem[] = [
    // Date & Time Section
    {
      id: 'date-time', label: 'Date & Time', icon: Calendar, children: [
    ...
    // Text Section
    {
      id: 'text', label: 'Text', icon: TextT, children: [
    ...
    // Numbers Section
    {
      id: 'numbers', label: 'Numbers', icon: Hash, children: [
        { id: 'compact', label: 'Compact Numbers', icon: Hash },
      ]
    },
    // Browser APIs
    {
      id: 'browser', label: 'Browser APIs', icon: Database, children: [
    ...
    // Utilities
    {
      id: 'utils', label: 'Utilities', icon: WarningCircle, children: [
  ...
  return (
    <div className="relative">
      <div className="fixed left-[max(0px,calc(50%-45rem))] top-24 w-64 hidden xl:block">
...
formatDate(new Date(), 'PP') // Output: "Jan 1, 2024"`}
              ...
              <section id="timeSince" className="space-y-4">
                <SectionHeader icon={Hourglass} title="Time Since" id="timeSince" />
                <div className="border p-4 rounded-lg space-y-2">
...
timeSince(new Date()) // "just now"`}
              ...
              <section id="humanize" className="space-y-4">
                <SectionHeader icon={Timer} title="Humanize Time" id="humanize" />
                <div className="border p-4 rounded-lg space-y-2">
...
generateSlug("This & That") // "this-and-that"`}
              ...
              <section id="initials" className="space-y-4">
                <SectionHeader icon={TextT} title="Extract Initials" id="initials" />
                <div className="border p-4 rounded-lg space-y-2">
...
extractInitials("John Middle Doe") // "JM"`}
            ...
            <div id="numbers" className="space-y-8">
              ...
              <section id="compact" className="space-y-4">
                <SectionHeader icon={Hash} title="Number Formatting" id="compact" />
                <div className="border p-4 rounded-lg space-y-2">
...
formatCompactNumber(987654) // "988K"`}
            ...
            <div id="browser" className="space-y-8">
              <h2 className="text-3xl font-bold tracking-tight">Browser APIs</h2>
              ...
              <section id="clipboard" className="space-y-4">
                ...
                <div className="border p-4 rounded-lg space-y-4">
                  <div className="flex items-center gap-2">
                    <Button
                      onClick={async () => {
                        const success = await copyToClipboard('Hello from clipboard!')
                  ...
                  <div className="space-y-2">
                    <p className="text-sm text-muted-foreground">Test it out! Paste here:</p>
                    <Input
