...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      'text-foreground/50 hover:text-foreground absolute top-2 right-2 rounded-md p-1 opacity-0 transition-opacity group-hover:opacity-100 group-[.destructive]:text-red-300 group-[.info]:text-blue-300 group-[.success]:text-green-300 group-[.warning]:text-yellow-300 group-[.destructive]:hover:text-red-50 group-[.info]:hover:text-blue-50 group-[.success]:hover:text-green-50 group-[.warning]:hover:text-yellow-50 focus:opacity-100 focus:ring-2 focus:outline-none group-[.destructive]:focus:ring-red-400 group-[.destructive]:focus:ring-offset-red-600 group-[.info]:focus:ring-blue-400 group-[.info]:focus:ring-offset-blue-600 group-[.success]:focus:ring-green-400 group-[.success]:focus:ring-offset-green-600 group-[.warning]:focus:ring-yellow-400 group-[.warning]:focus:ring-offset-yellow-600',
      className,
    )}
    toast-close=''
    {...props}
